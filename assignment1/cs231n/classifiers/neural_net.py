...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        grads['b2'] = scores.mean(axis=0)
        grads['W2'] = relu.T.dot(scores)/N + reg*W2
        partial = scores.dot(W2.T) * (1*relu!=0)
        grads['b1'] = partial.mean(axis=0)
        grads['W1'] = X.T.dot(partial)/N + reg*W1
